 ...
 */
var MWLayerAjax =new __WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.TileLayer.extend({
	_requests: [],
	...
	_update: function() {
		...
		__WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.TileLayer.prototype._update.apply(this, arguments);
	}
});
var MWTileLayer =new  MWLayerAjax.extend({
	...
	initialize: function(url, options, geojsonOptions) {
		...
		this.geojsonLayer = new __WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.GeoJSON(null, geojsonOptions);
	},
	onAdd: function(map) {
		this._map = map;
	...
	addTileData: function(geojson, tilePoint) {
		var features = __WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.Util.isArray(geojson) ? geojson : geojson.features,
			i, len, feature;
		...
		if(this.options.unique && typeof(this.options.unique) === 'function') {
			...
			try {
				incomingLayer = __WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.GeoJSON.geometryToLayer(geojson, options.pointToLayer, options.coordsToLatLng);
			}
			...
			incomingLayer.feature = __WEBPACK_IMPORTED_MODULE_0__static_leaflet_leaflet_js___default.a.GeoJSON.asFeature(geojson);
	...
	_tileLoaded: function(tile, tilePoint) {
		MWLayerAjax.prototype._tileLoaded.apply(this, arguments);
		if(tile.datum === null) {
			return null;
		}
